 ...
 */
static LoggingLevel _loggingLevelFromString(const char *loggingLevel) {
    if (strcmp(loggingLevel, "ALL") == 0) {
        return ALL;
    } else if (strcmp(loggingLevel, "DEBUGGING") == 0) {
        return DEBUGGING;
    } else if (strcmp(loggingLevel, "INFORMATION") == 0) {
        return INFORMATION;
    } else if (strcmp(loggingLevel, "WARNING") == 0) {
        return WARNING;
    } else if (strcmp(loggingLevel, "ERROR") == 0) {
        return ERROR;
    } else {
        return CRITICAL;
    }
